...
namespace Parus.Infrastructure.Migrations.ApplicationIdentityDb
{
    ...
    [Migration("20230906191645_AddAvatarPathDefaultValue")]
    partial class AddAvatarPathDefaultValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Naturistic.Infrastructure.Identity.PasswordRecoveryToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Naturistic.Infrastructure.Identity.PasswordRecoveryToken", b =>
                {
                    b.HasOne("Naturistic.Infrastructure.Identity.ApplicationUser", "User")
                        ...
                        .HasForeignKey("Naturistic.Infrastructure.Identity.PasswordRecoveryToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
